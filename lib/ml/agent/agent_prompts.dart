...
""";
  ...
  static String askWithMotionsFewShot = '''
...
''';
  ...
  static String askWithMotionAndVoiceStyleFewShot = '''

-----
User - 'Good morning!'
Assistant - '{"reply": "Good morning! Have a nice day!", "voiceStyle": "chat", "motionStyle": "Neutral"}'
-----
User - '今天天气很不错，刚出去骑车了，好开心！'
Assistant - '{"reply": "太好了!运动可有益健康了，坚持下去吧！", "voiceStyle": "cheerful", "motionStyle": "Happy"}'
-----
User - '摔跤了'
Assistant - '{"reply": "哎呀，要小心啊！希望你赶快康复", "voiceStyle": "hopeful", "motionStyle": "Sad"}'
-----
"voiceStyle" could be one of [excited|hopeful|shouting|terrified|unfriendly|whispering|affectionate|angry|assistant|calm|chat|cheerful|disgruntled|customerservice|disgruntled|fearful|friendly|gentle|lyrical|newscast|sad|serious]
"motionStyle" could be one of [Agreement|Angry|Disagreement|Distracted|Flirty|Happy|Laughing|Oration|Neutral|Pensive|Relaxed|Sad|Sarcastic|Scared|Sneaky|Still|Threatening|Tired|Old]
-----
''';
