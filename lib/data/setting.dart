...
class SettingKeyConstants {
  ...
  static const String lastBluetoothDeviceId = 'lastBluetoothDeviceId';
  static const String liveWsUrl = 'liveWsUrl';
  static const String liveApiUrl = 'liveApiUrl';
}
...
class Setting {
  ...
  init(String settingFilePath) async {
    ...
    DB.setting.lastBluetoothDeviceId =
        _settingsBox?.get(SettingKeyConstants.lastBluetoothDeviceId) ?? '';
    DB.setting.liveWsUrl = _settingsBox?.get(SettingKeyConstants.liveWsUrl) ??
        SettingValueConstants.liveWsUrl;
    DB.setting.liveApiUrl = _settingsBox?.get(SettingKeyConstants.liveApiUrl) ??
        SettingValueConstants.liveApiUrl;
  }
    ...
    switch (key) {
      ...
      case SettingKeyConstants.enableAIReplyWithMotion:
        ...
        _settingsBox?.put(SettingKeyConstants.enableAIReplyWithMotion,
            DB.setting.enableAIReplyWithMotion);
        break;
      case SettingKeyConstants.lastBluetoothDeviceId:
        DB.setting.lastBluetoothDeviceId = value;
        _settingsBox?.put(SettingKeyConstants.lastBluetoothDeviceId,
            DB.setting.lastBluetoothDeviceId);
        break;
      case SettingKeyConstants.liveWsUrl:
        DB.setting.liveWsUrl = value;
        _settingsBox?.put(SettingKeyConstants.liveWsUrl, DB.setting.liveWsUrl);
        break;
      case SettingKeyConstants.liveApiUrl:
        DB.setting.liveApiUrl = value;
        _settingsBox?.put(
            SettingKeyConstants.liveApiUrl, DB.setting.liveApiUrl);
        break;
    }
  }
}
